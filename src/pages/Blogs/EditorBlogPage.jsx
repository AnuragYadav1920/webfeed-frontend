...
const EditorBlogPage = () => {
  ...
  return (
    <>
      <div className='editor-blog-edit-container ' style={style}>
          <div className=' editor-blog-edit-container-box '>
                <div className='editor-blog-edit-container-box-image-box'>
                    <img src="images/mountain.avif" alt="" className='editor-blog-edit-container-box-image-box-image'/>
                    <div className='blog-edit-icon' onClick={()=>isEditedImage(!editedImage)}> 
                        <label htmlFor="blog-Image" className='cursor-pointer' >
                        <input type="file" id='blog-Image' className='blog-image-edit-input'/>
                          <MdEdit/>
                      </label>
                    </div>                  
                </div>
                <div className='editor-blog-edit-container-box-content'>
                  {/* Title */}
                    <div >
                      {
                        !editedTitle ?
                          <div className='editor-blog-edit-container-box-content-title-box'>
                            <span>A Tale Of The Decade</span>
                            <div className='blog-edit-icon'  onClick={()=>isEditedTitle(!editedTitle)}>
                              <MdEdit/>
                            </div>
                          </div> :
                            <div className='editor-blog-edit-container-box-content-title-box-edit-title'>
                              <input type="text" className='editor-blog-edit-container-box-content-title-box-edit-title-input' placeholder='edit your title' />
                              <div className='editor-blog-edit-container-box-content-title-save-delete-button-box'>
                                <span className='editor-blog-edit-container-box-content-title-save-delete-button-box-button save'>Save</span>
                                <span className='editor-blog-edit-container-box-content-title-save-delete-button-box-button delete' onClick={()=>isEditedTitle(!editedTitle)}>Cancel</span>
                              </div>
                            </div>
                ...
                <div>
                    {
                      !editedDescription?
                      <div className='editor-blog-edit-container-box-content-view-content'>
                    ...
                    :
                    <div className='editor-blog-edit-container-box-content-view-content-edit-box'>
                        <textarea name="" id="" className='editor-blog-edit-container-box-content-view-content-edit-box-textarea' rows={25}>
                        ...
                        <div className='content-center space-x-3'>
                           <span className='editor-blog-edit-container-box-content-title-save-delete-button-box-button save'>Save</span>
                            <span className='editor-blog-edit-container-box-content-title-save-delete-button-box-button delete' onClick={()=>isEditedDescription(!editedDescription)}>Cancel</span>
                        </div>
                    </div>
                  }
                </div>
              ...
              <div className='mb-20'>
                {
                  !editedDescription && (
                    <div className='blog-edit-icon-bottom' onClick={()=>isEditedDescription(!editedDescription)}>
                    <MdEdit/>
                    </div>
                  )
                }
